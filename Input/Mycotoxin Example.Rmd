...
out_default_df <- pivot_longer(out_default,cols=2:4)
# Plot
...
print.ggplot <- function(x, ...) {
  ...
  folder <- "C:/Users/lvisinti/OneDrive - UGent/Projects/TAMU modelling CIT/mycotoxin-pk-model-main/Mycotoxin-PK-model-main/Calibration Plots"
