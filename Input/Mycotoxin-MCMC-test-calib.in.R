...
Level { # population
  ...
  Level { # individual
    ...
    Simulation {
      ...
      Print(Ccpt_out, 0.25, 0.5, 1, 2, 4, 6, 8);
      Print (Qu_met_out, 48);
      Print(Qu_out, 2.5, 5, 9.5, 12, 25.5, 28.5, 31, 48, 52); 
      Data(Ccpt_out, 0.22, 0.32, 0.26, 0.26, 0.37, 0.11, 0.024);
      Data(Qu_met_out, 12088);
    ...
    Simulation {
      ...
      Data(Ccpt_out, 0.22, 0.26, 0.23, 0.19, 0.11, 0.12, 0.09, 0.08, 0.08, 0.06, 0.024);
      Data(Qu_met_out, 10963.9);
    ...
    Simulation {
      ...
      Data(Ccpt_out, 0.04, 0.08, 0.09, 0.17, 0.28, 0.16, 0.16, 0.09, 0.05);
      Data(Qu_met_out, 3052.44);
    ...
    Simulation {
      ...
      Data(Ccpt_out, 0.221, 0.29, 0.23, 0.21, 0.13, 0.09, 0.09, 0.06, 0.05, 0.024, 0.024);
      Data(Qu_met_out, 6302.11);
    ...
    Simulation {
      ...
      Data(Ccpt_out, 1.27, 0.97, 1.02, 0.48, 0.29, 0.42, 0.22, 0.12, 0.07, 0.07);
      Data(Qu_met_out, 10091.2);
    ...
    Simulation {
      ...
      Data(Ccpt_out, 2.44, 1.75, 0.40, 1.79, 0.18, 0.14, 0.05);
      Data(Qu_met_out, 10033);
    ...
    Simulation {
      ...
      Data(Ccpt_out, 0.34, 0.36, 0.20, 0.18, 0.16, 0.10, 0.09, 0.06, 0.024, 0.024);
      Data(Qu_met_out, 7009.7);
    ...
    Simulation {
      ...
      Data(Ccpt_out, 0.23, 0.25, 0.18, 0.17, 0.12, 0.11, 0.08, 0.06, 0.05, 0.024, 0.024);
      Data(Qu_met_out, 17558.5);
